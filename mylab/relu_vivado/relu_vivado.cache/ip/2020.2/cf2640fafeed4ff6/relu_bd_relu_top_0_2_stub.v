...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ relu_bd_relu_top_0_2_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_control_AWADDR, 
  ...
  s_axi_control_RREADY, ap_clk, ap_rst_n, interrupt, m_axi_din_AWADDR, m_axi_din_AWLEN, 
  m_axi_din_AWSIZE, m_axi_din_AWBURST, m_axi_din_AWLOCK, m_axi_din_AWREGION, 
  m_axi_din_AWCACHE, m_axi_din_AWPROT, m_axi_din_AWQOS, m_axi_din_AWVALID, 
  m_axi_din_AWREADY, m_axi_din_WDATA, m_axi_din_WSTRB, m_axi_din_WLAST, m_axi_din_WVALID, 
  m_axi_din_WREADY, m_axi_din_BRESP, m_axi_din_BVALID, m_axi_din_BREADY, m_axi_din_ARADDR, 
  m_axi_din_ARLEN, m_axi_din_ARSIZE, m_axi_din_ARBURST, m_axi_din_ARLOCK, 
  ...
  m_axi_din_RVALID, m_axi_din_RREADY)
