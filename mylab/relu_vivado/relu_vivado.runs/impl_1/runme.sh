...
HD_PWD='C:/Users/dianhsu/Desktop/Using_IP_with_Zynq/mylab/relu_vivado/relu_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log relu_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source relu_bd_wrapper.tcl -notrace
