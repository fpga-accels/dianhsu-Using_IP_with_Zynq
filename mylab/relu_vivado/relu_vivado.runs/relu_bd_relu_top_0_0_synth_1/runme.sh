...
HD_PWD='C:/Users/dianhsu/Desktop/Using_IP_with_Zynq/mylab/relu_vivado/relu_vivado.runs/relu_bd_relu_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log relu_bd_relu_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source relu_bd_relu_top_0_0.tcl
