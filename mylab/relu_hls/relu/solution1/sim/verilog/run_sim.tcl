...
if {[file isfile relu_top.autotvin.dat]} {
	file delete -force relu_top.autotvin.dat
}

if {[file isfile relu_top.autotvout.dat]} {
	file delete -force relu_top.autotvout.dat
}
