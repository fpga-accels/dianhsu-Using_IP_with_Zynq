...
define i32 @apatb_relu_top_ir([128 x [128 x float]]* %din) local_unnamed_addr #0 {
entry:
  ...
  %2 = call i32 @apatb_relu_top_hw([128 x [128 x float]]* %1)
...
declare i32 @apatb_relu_top_hw([128 x [128 x float]]*)

define i32 @relu_top_hw_stub_wrapper([128 x [128 x float]]*) #5 {
entry:
  ...
  %3 = call i32 @relu_top_hw_stub([128 x [128 x float]]* %2)
  call void @copy_in([3 x [128 x [128 x float]]]* null, [3 x [128 x [128 x float]]]* %1)
  ret i32 %3
}

declare i32 @relu_top_hw_stub([128 x [128 x float]]*)
