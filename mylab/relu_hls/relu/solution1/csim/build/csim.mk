...
HLS_SOURCES = ../../../../relu_tb.cpp ../../../../relu.cpp
...
$(ObjDir)/relu_tb.o: ../../../../relu_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../relu_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/relu_tb.d
