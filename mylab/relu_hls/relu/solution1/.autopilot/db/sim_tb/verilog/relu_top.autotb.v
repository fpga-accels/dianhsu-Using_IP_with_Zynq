...
`define AUTOTB_TVOUT_ap_return  "./c.relu_top.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.relu_top.autotvout_gmem.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.relu_top.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 885511;
parameter LENGTH_gmem = 49152;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.relu_top.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.relu_top.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.relu_top.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.relu_top.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.relu_top.autotvout_ap_return.dat with impl_rtl.relu_top.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
