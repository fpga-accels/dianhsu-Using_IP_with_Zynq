...
HD_PWD='C:/Users/dianhsu/Desktop/Using_IP_with_Zynq/mylab2/vivado/relu/relu.runs/relu_bd_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log relu_bd_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source relu_bd_rst_ps7_0_100M_0.tcl
