...
HLS_SOURCES = ../../../../test_relu.cpp ../../../../relu.cpp
...
$(ObjDir)/test_relu.o: ../../../../test_relu.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../test_relu.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/test_relu.d
