...
`define AUTOTB_DUT      relu_top
`define AUTOTB_DUT_INST AESL_inst_relu_top
`define AUTOTB_TOP      apatb_relu_top_top
`define AUTOTB_LAT_RESULT_FILE "relu_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "relu_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_relu_top_top
...
`define AESL_DEPTH_positive_r 1
`define AESL_DEPTH_negative 1
`define AUTOTB_TVIN_gmem  "./c.relu_top.autotvin_gmem.dat"
`define AUTOTB_TVIN_din  "./c.relu_top.autotvin_din.dat"
`define AUTOTB_TVIN_dout  "./c.relu_top.autotvin_dout.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.relu_top.autotvin_gmem.dat"
`define AUTOTB_TVIN_din_out_wrapc  "./rtl.relu_top.autotvin_din.dat"
`define AUTOTB_TVIN_dout_out_wrapc  "./rtl.relu_top.autotvin_dout.dat"
`define AUTOTB_TVOUT_gmem  "./c.relu_top.autotvout_gmem.dat"
`define AUTOTB_TVOUT_positive_r  "./c.relu_top.autotvout_positive_r.dat"
`define AUTOTB_TVOUT_negative  "./c.relu_top.autotvout_negative.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.relu_top.autotvout_gmem.dat"
`define AUTOTB_TVOUT_positive_r_out_wrapc  "./impl_rtl.relu_top.autotvout_positive_r.dat"
`define AUTOTB_TVOUT_negative_out_wrapc  "./impl_rtl.relu_top.autotvout_negative.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 82;
parameter LENGTH_gmem = 128;
parameter LENGTH_din = 1;
parameter LENGTH_dout = 1;
parameter LENGTH_positive_r = 1;
parameter LENGTH_negative = 1;
...
reg end_positive_r;
reg [31:0] size_positive_r;
reg [31:0] size_positive_r_backup;
reg end_negative;
reg [31:0] size_negative;
reg [31:0] size_negative_backup;
...
reg dump_tvout_finish_positive_r;

initial begin : dump_tvout_runtime_sign_positive_r
    integer fp;
    dump_tvout_finish_positive_r = 0;
    fp = $fopen(`AUTOTB_TVOUT_positive_r_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_positive_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_positive_r_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_positive_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_positive_r = 1;
end


reg dump_tvout_finish_negative;

initial begin : dump_tvout_runtime_sign_negative
    integer fp;
    dump_tvout_finish_negative = 0;
    fp = $fopen(`AUTOTB_TVOUT_negative_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_negative_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_negative_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_negative_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
