...
void XRelu_top_Set_dout(XRelu_top *InstancePtr, u64 Data) {
    ...
    XRelu_top_WriteReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_DOUT_DATA, (u32)(Data));
    XRelu_top_WriteReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_DOUT_DATA + 4, (u32)(Data >> 32));
}
...
u64 XRelu_top_Get_dout(XRelu_top *InstancePtr) {
    ...
    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_DOUT_DATA);
    Data += (u64)XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_DOUT_DATA + 4) << 32;
    return Data;
}

void XRelu_top_Set_positive_r_i(XRelu_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRelu_top_WriteReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_POSITIVE_R_I_DATA, Data);
}

u32 XRelu_top_Get_positive_r_i(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_POSITIVE_R_I_DATA);
    return Data;
}

u32 XRelu_top_Get_positive_r_o(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_POSITIVE_R_O_DATA);
    return Data;
}

u32 XRelu_top_Get_positive_r_o_vld(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_POSITIVE_R_O_CTRL);
    return Data & 0x1;
}

void XRelu_top_Set_negative_i(XRelu_top *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XRelu_top_WriteReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_NEGATIVE_I_DATA, Data);
}

u32 XRelu_top_Get_negative_i(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_NEGATIVE_I_DATA);
    return Data;
}

u32 XRelu_top_Get_negative_o(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_NEGATIVE_O_DATA);
    return Data;
}

u32 XRelu_top_Get_negative_o_vld(XRelu_top *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XRelu_top_ReadReg(InstancePtr->Control_BaseAddress, XRELU_TOP_CONTROL_ADDR_NEGATIVE_O_CTRL);
    return Data & 0x1;
}
