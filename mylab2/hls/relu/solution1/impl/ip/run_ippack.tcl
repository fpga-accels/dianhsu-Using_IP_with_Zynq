...
set IPName      "relu_top"
set Version     "1.0"
set DisplayName "Relu_top"
set Revision    "2101270303"
...
set xo_kernel_name "relu_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/dianhsu/Desktop/Using_IP_with_Zynq/mylab2/hls/relu/solution1"
set debug_dir "C:/Users/dianhsu/Desktop/Using_IP_with_Zynq/mylab2/hls/relu/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {relu_top_fcmp_32ns_32ns_1_2_no_dsp_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 din_1 W 0x0 "Data signal of din" {{0 32 din W 0 "Bit 31 to 0 of din"}}} {0x14 din_2 W 0x0 "Data signal of din" {{0 32 din W 0 "Bit 63 to 32 of din"}}} {0x1c dout_1 W 0x0 "Data signal of dout" {{0 32 dout W 0 "Bit 31 to 0 of dout"}}} {0x20 dout_2 W 0x0 "Data signal of dout" {{0 32 dout W 0 "Bit 63 to 32 of dout"}}} {0x28 positive_r_i W 0x0 "Data signal of positive_r_i" {{0 32 positive_r_i W 0 "Bit 31 to 0 of positive_r_i"}}} {0x30 positive_r_o R 0x0 "Data signal of positive_r_o" {{0 32 positive_r_o R 0 "Bit 31 to 0 of positive_r_o"}}} {0x34 positive_r_o_ctrl R 0x0 "Control signal of positive_r_o" {{0 1 positive_r_o_ap_vld R 0 "Control signal positive_r_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 negative_i W 0x0 "Data signal of negative_i" {{0 32 negative_i W 0 "Bit 31 to 0 of negative_i"}}} {0x40 negative_o R 0x0 "Data signal of negative_o" {{0 32 negative_o R 0 "Bit 31 to 0 of negative_o"}}} {0x44 negative_o_ctrl R 0x0 "Control signal of negative_o" {{0 1 negative_o_ap_vld R 0 "Control signal negative_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 82 II x}
