...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.relu_top.autotvin_gmem.dat"
         "c.relu_top.autotvin_din.dat"
         "c.relu_top.autotvin_dout.dat"
         "c.relu_top.autotvout_gmem.dat"
         "c.relu_top.autotvout_positive_r.dat"
         "c.relu_top.autotvout_negative.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.relu_top.autotvout_gmem.dat"
         "rtl.relu_top.autotvout_positive_r.dat"
         "rtl.relu_top.autotvout_negative.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
