...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "relu_top.autotvin.dat"
	set constFileTvOut       "relu_top.autotvout.dat"
	set constFileHdlTvIn     "relu_top.autohdltvin.dat"
	set constFileHdlTvOut    "relu_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
